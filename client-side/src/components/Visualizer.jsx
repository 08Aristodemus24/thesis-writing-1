...
export default function Visualizer({ children, props }){
    ...
    // under the svg element, if there is remove it
    ...
    return (
        ...
        <div className={`spreadsheet-graph-container ${design}`} style={style}>
