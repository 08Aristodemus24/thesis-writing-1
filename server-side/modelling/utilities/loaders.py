...
def concur_load_data(feat_config: str="Taylor"):
    """
    ...
    if feat_config.capitalize() == "Taylor" or feat_config.capitalize() == "Hossain":
        ...
        dir = f'./data/Artifact Detection Data/train/'
        ...
        dir = f'./data/Electrodermal Activity artifact correction BEnchmark (EDABE)/Train/'
